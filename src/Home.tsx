          ...
          <div className="max-w-4xl mx-auto w-full">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight mb-6">
                <Typewriter text="Construa seu primeiro site com IA" speed={70} />
              </h1>
              <p className="text-lg text-slate-400 max-w-xl mx-auto">
                Descubra a estrutura de tudo na internet. Não se assuste. Por trás de toda página complexa, aplicativo ou sistema milionário, existe uma estrutura surpreendentemente simples.
              </p>
            </motion.div>
